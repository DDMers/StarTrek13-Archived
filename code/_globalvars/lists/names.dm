...
GLOBAL_LIST_INIT(romulan_first_names, world.file2list("strings/names/romulan_first.txt"))
GLOBAL_LIST_INIT(romulan_last_names, world.file2list("strings/names/romulan_last.txt"))
