...
/client/proc/cmd_admin_pm(whom, msg)
	...
	if(!holder && !current_ticket)	//no ticket? https://www.youtube.com/watch?v=iHSPf6x1Fdo
		...
		to_chat(src, "<font color='#7289da'>Message: [msg]</font>")
		return
	...
	if(irc)
		to_chat(src, "<font color='#7289da'>PM to-<b>Admins</b>: <span class='linkify'>[rawmsg]</span></font>")
		...
		if(recipient.holder)
			if(holder)	//both are admins
				...
				to_chat(src, "<font color='#7289da'>Admin PM to-<b>[key_name(recipient, src, 1)]</b>: <span class='linkify'>[keywordparsedmsg]</span></font>")
				...
				to_chat(src, "<font color='#7289da'>PM to-<b>Admins</b>: <span class='linkify'>[msg]</font></font>")
			...
			if(holder)	//sender is an admin but recipient is not. Do BIG RED TEXT
				...
				to_chat(src, "<font color='#7289da'>Admin PM to-<b>[key_name(recipient, src, 1)]</b>: <span class='linkify'>[msg]</span></font>")

				admin_ticket_log(recipient, "<font color='#7289da'>PM From [key_name_admin(src)]: [keywordparsedmsg]</font>")
	...
	if(irc)
		...
		for(var/client/X in GLOB.admins)
			to_chat(X, "<font color='#7289da'><B>PM: [key_name(src, X, 0)]-&gt;IRC:</B> [keywordparsedmsg]</font>")
	else
		...
		for(var/client/X in GLOB.admins)
			if(X.key!=key && X.key!=recipient.key)	//check client/X is an admin and isn't the sender or recipient
				to_chat(X, "<font color='#7289da'><B>PM: [key_name(src, X, 0)]-&gt;[key_name(recipient, X, 0)]:</B> [keywordparsedmsg]</font>" )
...
/proc/IrcPm(target,msg,sender)
	...
	admin_ticket_log(C, "<font color='#7289da'>PM From [irc_tagged]: [msg]</font>")
